...
const socialLinks = [
  { icon: Phone, label: 'Phone', href: 'tel:+962798097308', color: 'hover:text-primary', display: '+962 79 809 7308' },
  { icon: Mail, label: 'Email', href: 'mailto:ibrahim.alnaser@gmail.com', color: 'hover:text-primary', display: 'ibrahim.alnaser@gmail.com' },
  { icon: Instagram, label: 'Instagram', href: 'https://www.instagram.com/ibrahim_alnaser.15', color: 'hover:text-[#E4405F]', display: '@ibrahim_alnaser.15' },
];
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-12 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interested in basketball coaching, training sessions, or collaborations? Let's connect and discuss how we can work together.
          </p>
        </div>
          ...
          {socialLinks.map((social, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">{social.display}</p>
        ...
        <div className="mt-12 flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <span className="text-sm">Based in Irbid, Jordan</span>
        </div>
      </div>
    </section>
  );
